				...
				<div class="row g-4">
					<div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Update Payment</h6>
                            <form action=PaymentController method="POST">
                            	<input type="hidden" name="paymentId" id="paymentId" value="<c:out value="${payment.paymentId}"/>"/>
                                <div class="row mb-3">
                                    <label for="paymentAmount" class="col-sm-2 col-form-label">Payment Amount</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="paymentAmount" id="paymentAmount" class="form-control" value="${payment.paymentAmount}"/>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="parcelId" id="parcelId" class="form-control" value="${payment.parcelId}"/>
                                    </div>
                                </div>
