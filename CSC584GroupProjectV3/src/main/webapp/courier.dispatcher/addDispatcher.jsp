            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="img/blankProfile.jpg" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="img/blankProfile.jpg" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Add Dispatcher</h6>
                            <form action="DispatcherController" method="POST">
                                <div class="row mb-3">
                                    <label for="dispatcherFirstName" class="col-sm-2 col-form-label">First Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="dispatcherFirstName" name="dispatcherFirstName" placeholder="First Name" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="dispatcherLastName" class="col-sm-2 col-form-label">Last Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="dispatcherLastName" name="dispatcherLastName" placeholder="Last Name" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="dispatcherPhoneNumber" class="col-sm-2 col-form-label">Phone Number</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="dispatcherPhoneNumber" name="dispatcherPhoneNumber" placeholder="Phone Number" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="dispatcherEmail" class="col-sm-2 col-form-label">Email</label>
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="dispatcherEmail" name="dispatcherEmail" placeholder="Email" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="dispatcherAddress" class="col-sm-2 col-form-label">Address</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="dispatcherAddress" name="dispatcherAddress" placeholder="Address" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" id="dispatcherEmploymentTypeFullTime" name="dispatcherEmploymentType" value="Full-time">
                                            <label class="form-check-label" for="dispatcherEmploymentTypeFullTime">Full-time</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" id="dispatcherEmploymentTypePartTime" name="dispatcherEmploymentType" value="Part-time">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" id="dispatcherStatusActive" name="dispatcherStatus" value="Active">
                                            <label class="form-check-label" for="dispatcherStatusActive">Active</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" id="dispatcherStatusInactive" name="dispatcherStatus" value="Inactive">
