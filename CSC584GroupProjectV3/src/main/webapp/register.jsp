                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="RegisterController" method="POST">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="staffFirstName" name="staffFirstName" placeholder="First Name" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="staffLastName" class="col-sm-2 col-form-label">Last Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="staffLastName" name="staffLastName" placeholder="Last Name" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="staffPhoneNumber" class="col-sm-2 col-form-label">Phone Number</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="staffPhoneNumber" name="staffPhoneNumber" placeholder="Phone Number" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="staffEmail" class="col-sm-2 col-form-label">Email</label>
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="staffEmail" name="staffEmail" placeholder="Email" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="staffAddress" class="col-sm-2 col-form-label">Address</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" id="staffRoleDispatcher" name="staffRole" value="Dispatcher">
                                            <label class="form-check-label" for="staffRoleDispatcher">Dispatcher</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" id="staffRoleAdmin" name="staffRole" value="Admin">
                                            <label class="form-check-label" for="staffRoleAdmin">Admin</label>
                                        </div>
                                    </div>
                                </div>
