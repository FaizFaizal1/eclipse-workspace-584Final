		...
		<div class="sidebar pe-4 pb-3">
			<nav class="navbar bg-secondary navbar-dark">
				...
				<div class="navbar-nav w-100">
					...
					<a href="AdminController?action=updateAdminProfile" class="nav-item nav-link"><i class="fa fa-address-card me-2"></i>Update Profile</a> 
		...
		<div class="content">
			...
			<div class="container-fluid pt-4 px-4">
				<div class="bg-secondary rounded p-4">
					<h5 class="mb-4">Manage Admins</h5> <a href="AdminController?action=addAdmin" class="btn btn-primary">Add Admin</a>
						...
						<table class="table table-bordered table-striped table-hover mb-0">
							...
							<tbody>
								<c:forEach items="${admins}" var="admin">
									<tr>
									    <td><c:out value="${admin.staffId}" /></td>
									    <td><c:out value="${admin.staff.staffFirstName}" /></td>
									    <td><c:out value="${admin.staff.staffLastName}" /></td>
									    <td><c:out value="${admin.staff.staffPhoneNumber}" /></td>  
									    <td><c:out value="${admin.staff.staffEmail}" /></td>
									    <td><c:out value="${admin.staff.staffAddress}" /></td>
									    <td><c:out value="${admin.staff.staffDateOfHire}" /></td>
									    <td><c:out value="${admin.adminRole}" /></td>
									<td><a href="AdminController?action=viewAdmin&staffId=<c:out value="${admin.staffId}"/>" class="btn btn-primary">View</a> |
									<a href="AdminController?action=updateAdmin&staffId=<c:out value="${admin.staffId}"/>" class="btn btn-primary">Update</a> |
									<a href="AdminController?action=deleteAdmin&staffId=<c:out value="${admin.staffId}"/>" class="btn btn-primary">Delete</a> </td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
