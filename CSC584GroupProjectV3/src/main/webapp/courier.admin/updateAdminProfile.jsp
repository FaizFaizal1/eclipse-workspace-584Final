                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="AdminController" method="POST">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="adminFirstName" name="adminFirstName" placeholder="First Name" value="<c:out value="${staff.staffFirstName}"/>" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="adminLastName" class="col-sm-2 col-form-label">Last Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="adminLastName" name="adminLastName" placeholder="Last Name" value="<c:out value="${staff.staffLastName}"/>" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="adminPhoneNumber" class="col-sm-2 col-form-label">Phone Number</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="adminPhoneNumber" name="adminPhoneNumber" placeholder="Phone Number" value="<c:out value="${staff.staffPhoneNumber}"/>" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="adminAddress" class="col-sm-2 col-form-label">Address</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="adminAddress" name="adminAddress" placeholder="Address" value="<c:out value="${staff.staffAddress}"/>" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="adminEmail" class="col-sm-2 col-form-label">Email</label>
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="adminEmail" name="adminEmail" placeholder="Email" value="<c:out value="${staff.staffEmail}"/>" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
